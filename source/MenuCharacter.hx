...
class MenuCharacter extends FlxSprite
{
	private static var settings:Map<String, CharacterSetting> = [
		...
		'kadedev' => new CharacterSetting(-115, 235, 1.0),
	];
	...
	public function new(x:Int, y:Int, scale:Float, flipped:Bool, customSparrow:String = "campaign_menu_UI_characters", customLib:String = "preload",
			customCharacter:String = "bf", customPrefix:String = "BF idle dance white")
	{
		super(x, y);
		this.flipped = flipped;
		...
		frames = Paths.getSparrowAtlas(customSparrow, customLib);

		if (customSparrow != "campaign_menu_UI_characters")
		{
			animation.addByPrefix(customCharacter, customPrefix, 24, false);
		}
		else
		{
